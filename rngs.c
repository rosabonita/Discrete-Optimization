/* -------------------------------------------------------------------------
 * This is an ANSI C library for multi-stream random number generation.  The 
 * use of this library is recommended as a replacement for the ANSI C 
...
/* ======================================================================
 * Use this (optional) function to set the state of all the random number
 * generator streams by "planting" a sequence of states (seeds), one per 
 * stream, with all states dictated by the state of the default stream. 
 ...
 */
{
  ...
  void PutSeed(long x)
/* ===================================================================
 * Use this (optional) function to set the state of the current random 
 * number generator stream according to the following conventions:
 ...
 */
{
  ...
  void GetSeed(long *x)
/* ===================================================================
 * Use this (optional) function to get the state of the current random
 * number generator stream.                                                   
 * ===================================================================
 */
{
  *x = seed[stream];
